...
[Qlik Sense](http://www.qlik.com/us/products/qlik-sense) is a modern business intelligence tool from Qlik that provides users with self-service visualization. With this tool, users can create highly interactive dashboards that utilize [Qlik’s Associative Model](http://www.qlik.com/us/products/why-qlik-is-different) for rapid exploration of the data. Through this intuitive process, users can not only answer their initial questions but discover new avenues that lead them to additional insights below the surface.
</br>
</br>

*Try for yourself in this demo Qlik Sense Dashboard*
...
<div id="move-past-basics" class="graph">![](./imgs/move-past-basics.png)</div>
...
Fortunately, Qlik offers a solution for these custom scenarios with its open ecosystem. Qlik has introduced a set of [APIs](http://help.qlik.com/en-US/sense-developer/June2017/Content/APIs-and-SDKs.htm) that enable users to extend their products, allowing us to build custom solutions with Qlik Sense and the QIX Engine. These solutions allow us to incorporate Qlik’s visual analytics capabilities into any other environment, opening up a world of options for seamless and innovative data discovery.
</br>
</br>

There are 3 main ways that users customize the Qlik Sense experience:
1. Customizing the Qlik Sense Client with Extensions to enable new functionality and advanced charting
2. Embedding Qlik Sense analytics into other environments, so that Qlik Sense can be used within other portals or rebranded completely
3. Integrating the QIX Engine into custom solutions in order to leverage the data of the QIX Engine with any technology
</br>
</br>
...
In this scenario, users are still using the Qlik Sense client directly, but with some custom components added in. [Qlik Branch](http://branch.qlik.com/#!/) is a community of developers that share open source Qlik Sense extensions. Try out some of the unique visualizations there, such as:
* [a Sankey Diagram for visualizing flows between entities](http://branch.qlik.com/#!/project/568aa0b06ed0f0f47a89d7f2)
* [a Correlation Matrix for looking at relationships between measures](http://branch.qlik.com/#!/project/56d9fb513554326d5fc03ae3)
* [a Hex Bin plot for aggregating dense scatter plots into larger groups](http://branch.qlik.com/#!/project/56728f52d1e497241ae697e6)
</br>
</br>
...
Looking to connect with other developers who are also implementing their own custom solutions in the Qlik Sense Open Ecosystem? Come join the [Qlik Branch Slack channel](http://qlikbranch-slack-invite.herokuapp.com/) to get connected.
