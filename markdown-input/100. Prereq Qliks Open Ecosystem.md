...
<div class="graph">![](./imgs/monitor-qs.png)</div>
...
link: [https://sense-demo.qlik.com/site/sense/app/372cbc85-f7fb-4db6-a620-9a5367845dce](https://sense-demo.qlik.com/site/sense/app/372cbc85-f7fb-4db6-a620-9a5367845dce)

<div class="graph">![](./imgs/youtube.png)</div>
...
[https://www.youtube.com/watch?v=85QHuNNeaCg](https://www.youtube.com/watch?v=85QHuNNeaCg)
...
<div class="graph">![](./imgs/self-service-640.gif)</div>
...
<div class="graph">![](./imgs/qix-engine.png)</div>
...
<div class="graph">![](./imgs/qlik-ecosystem.png)</div>

With this in mind, the Qlik Sense experience looks more like this:

As a user interacts with the Qlik Sense Client in their browser, it is communicating with the QIX Engine on a Qlik Server to update the data based on the user’s instructions. New data is then sent back to the Qlik Sense Client, where it can be rendered in the browser as an updated dashboard.
...
<div class="graph">![](./imgs/qlik-sense-extension.png)</div>
...
<div class="graph">![](./imgs/mashup.png)</div>
...
<div class="graph">![](./imgs/custom-apps.png)</div>
