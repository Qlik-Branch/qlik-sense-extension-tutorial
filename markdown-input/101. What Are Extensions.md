...
<div id="ext-sunburst" class="graph">![](./imgs/ext-sunburst.png)</div>
...
<div id="ext-navigation" class="graph">![](./imgs/ext-navigation.gif)</div>
...
<div id="ext-resize" class="graph">![](./imgs/ext-resize.gif)</div>
...
<div id="sense-sankey-desktop" class="graph">![](./imgs/sense-sankey-download.png)![](./imgs/sense-sankey-folder.png)![](./imgs/sense-sankey-custom-objects.png)</div>

### Qlik Sense Desktop
On Qlik Sense Desktop, the code for an extension lives in a folder on our machine. We can directly create, edit, and remove extension code from this folder, and Qlik Sense Desktop will pull those extensions in. The location of this folder is _Users\{your-username}\Documents\Qlik\Sense\Extensions_. To install an extension, all we need to do is:
</br>
</br>
1. Download the folder containing the extension code

2. Place the extension folder into the directory _Users\{your-username}\Documents\Qlik\Sense\Extensions_

3. Open Qlik Sense Desktop and we will have access to that extension in the left panel under the Custom Objects sub-panel! 

<div id="sense-sankey-server" class="graph">![](./imgs/import-extensions.png)![](./imgs/sense-sankey-custom-objects.png)</div>
...
<div id="drag-drop-ext" class="graph">![](./imgs/drag-drop-ext.gif)</div>
