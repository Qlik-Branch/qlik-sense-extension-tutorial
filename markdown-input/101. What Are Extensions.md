...
<div class="graph">![](./imgs/ext-sunburst.png)</div>
...
<div class="graph">![](./imgs/ext-navigation.gif)</div>
...
<div class="graph">![](./imgs/ext-resize.gif)</div>
...
<div class="graph">![](./imgs/sense-sankey-download.png)</div>

1. Download the folder containing the extension code

<div class="graph">![](./imgs/sense-sankey-folder.png)</div>

2. Place the extension folder into the directory _Users\{our-username}\Documents\Qlik\Sense\Extensions_

<div class="graph">![](./imgs/sense-sankey-custom-objects.png)</div>
...
<div class="graph">![](./imgs/import-extensions.png)</div>
...
<div class="graph">![](./imgs/drag-drop-ext.gif)</div>
